...
- `fix: <summary> (anima#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (anima#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "anima#$pr_number" || { echo "ERROR: commit subject missing anima#$pr_number"; exit 1; }
