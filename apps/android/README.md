## Anima Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_anima-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm anima gateway --port 18789 --verbose
```
