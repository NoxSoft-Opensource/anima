...
enum GatewaySettingsStore {
    private static let gatewayService = "net.noxsoft.anima.gateway"
    private static let nodeService = "net.noxsoft.anima.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "net.noxsoft.anima.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "net.noxsoft.anima.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("anima-gateway.log")
    }
