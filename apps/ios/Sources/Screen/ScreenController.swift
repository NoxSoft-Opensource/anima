...
final class ScreenController {
    ...
    /// Callback invoked when an anima:// deep link is tapped in the canvas
...
/// Handles navigation policy to intercept anima:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept anima:// deep links.
        if url.scheme?.lowercased() == "anima" {
