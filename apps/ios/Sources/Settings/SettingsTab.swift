...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AnimaLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AnimaLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "net.noxsoft.anima.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AnimaLocationMode.off.rawValue)
                            Text("While Using").tag(AnimaLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AnimaLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Anima is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AnimaLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: AnimaLocationMode {
        AnimaLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
