...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Anima token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: AnimaOAuthStore.AnthropicOAuthStatus = AnimaOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "net.noxsoft.anima", category: "anthropic-oauth")
...
enum AnimaOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let animaOAuthDirEnv = "ANIMA_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Anima OAuth token file not found"
            case .unreadableFile: "Anima OAuth token file not readable"
            case .invalidJSON: "Anima OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Anima OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Anima OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.animaOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".anima", isDirectory: true)
