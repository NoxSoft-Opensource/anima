...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AnimaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AnimaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AnimaConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/anima"
        state.remoteCliPath = ""
        return state
    }
}
