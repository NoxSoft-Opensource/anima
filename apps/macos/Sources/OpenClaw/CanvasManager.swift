...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "net.noxsoft.anima", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Anima/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__anima__/a2ui/").absoluteString + "?platform=macos"
    }
