...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "net.noxsoft.anima", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        AnimaPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AnimaPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
