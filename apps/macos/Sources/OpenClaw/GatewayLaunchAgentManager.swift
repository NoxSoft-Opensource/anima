...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "net.noxsoft.anima", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".anima/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.animaCommand(
            subcommand: "gateway",
