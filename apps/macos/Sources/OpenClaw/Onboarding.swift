...
enum UIStrings {
    static let welcomeTitle = "Welcome to Anima"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "anima.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AnimaOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AnimaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g anima@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AnimaChatViewModel(
