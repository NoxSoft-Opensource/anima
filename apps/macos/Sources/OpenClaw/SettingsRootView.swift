...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .animaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AnimaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AnimaPaths.stateDirURL.path
...
extension Notification.Name {
    static let animaSelectSettingsTab = Notification.Name("animaSelectSettingsTab")
}
