...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "net.noxsoft.anima", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "net.noxsoft.anima", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AnimaChatMessage] = messages.compactMap { item in
