...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "net.noxsoft.anima", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Anima windows, but below the system’s pop-up menus.
