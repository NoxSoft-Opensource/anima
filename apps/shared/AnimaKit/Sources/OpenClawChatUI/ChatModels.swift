...
public typealias AnimaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AnimaPlatformImage = UIImage
#endif

public struct AnimaChatUsageCost: Codable, Hashable, Sendable {
...
public struct AnimaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AnimaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AnimaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AnimaChatMessageContent: Codable, Hashable, Sendable {
...
public struct AnimaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AnimaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AnimaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AnimaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AnimaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AnimaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AnimaChatMessageContent].self, forKey: .content) {
...
public struct AnimaChatHistoryPayload: Codable, Sendable {
...
public struct AnimaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AnimaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AnimaSessionPreviewItem]
}

public struct AnimaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AnimaSessionPreviewEntry]

    public init(ts: Int, previews: [AnimaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AnimaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AnimaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AnimaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AnimaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AnimaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AnimaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AnimaPlatformImage?
...
public struct AnimaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
