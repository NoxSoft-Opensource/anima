...
import "@a2ui/lit/ui";
import { themeContext } from "@anima/a2ui-theme-context";
...
class AnimaA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  #handleA2UIAction(evt) {
    ...
    const handler =
      globalThis.webkit?.messageHandlers?.animaCanvasA2UIAction ??
      globalThis.animaCanvasA2UIAction;
