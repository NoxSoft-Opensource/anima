...
@MainActor
public struct AnimaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AnimaChatViewModel
    ...
    private var visibleMessages: [AnimaChatMessage] {
        let base: [AnimaChatMessage]
    ...
    private func mergeToolResults(in messages: [AnimaChatMessage]) -> [AnimaChatMessage] {
    ...
    private func isToolResultMessage(_ message: AnimaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AnimaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AnimaChatMessage) -> String {
