...
public enum AnimaCanvasA2UICommand: String, Codable, Sendable {
...
public struct AnimaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AnimaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
