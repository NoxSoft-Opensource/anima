...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "net.noxsoft.anima", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "net.noxsoft.anima", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AnimaProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
