...
anima system heartbeat last
anima logs --follow
anima config get agents.defaults.heartbeat
anima channels status --probe
```
...
```bash
anima config get agents.defaults.heartbeat.activeHours
anima config get agents.defaults.heartbeat.activeHours.timezone
anima config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
anima cron list
anima logs --follow
```
