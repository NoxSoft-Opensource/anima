...
- Install via CLI: `anima plugins install @anima/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `anima plugins install ./extensions/zalo`
   - From npm (if published): `anima plugins install @anima/zalo`
...
- Approve via:
  - `anima pairing list zalo`
  - `anima pairing approve zalo <CODE>`
...
- Example: `anima message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `anima channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `anima logs --follow`
