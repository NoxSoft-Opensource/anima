...
Anima has two separate “streaming” layers:
...
When block streaming is enabled, Anima can **merge consecutive block chunks**
...
When draft streaming is active, Anima disables block streaming for that reply to avoid double-streaming.
