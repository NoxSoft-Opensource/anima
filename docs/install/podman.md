...
Run the Anima gateway in a **rootless** Podman container. Uses the same image as Docker (build from the repo [Dockerfile](https://github.com/anima/anima/blob/main/Dockerfile)).
