...
Anima treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.anima/settings/voicewake.json`

Shape:

```json
{ "triggers": ["anima", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
