...
This guide summarizes a sane workflow for working on the pi integration in Anima.
...
- Trigger the agent directly:
  - `pnpm anima agent --message "Hello" --thinking low`
...
State lives under the Anima state directory. Default is `~/.anima`. If `ANIMA_STATE_DIR` is set, use that directory instead.

To reset everything:

- `anima.json` for config
...
- [https://docs.noxsoft.net/anima/testing](https://docs.noxsoft.net/anima/testing)
- [https://docs.noxsoft.net/anima/start/getting-started](https://docs.noxsoft.net/anima/start/getting-started)
