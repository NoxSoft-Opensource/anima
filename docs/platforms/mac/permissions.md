...
- Same path: run the app from a fixed location (for Anima, `dist/Anima.app`).
...
Workaround: move files into the Anima workspace (`~/.anima/workspace`) if you want to avoid per-folder grants.
