...
read_when:
  - You are building a Anima plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (anima.plugin.json)

Every plugin **must** ship a `anima.plugin.json` file in the **plugin root**.
Anima uses this manifest to validate configuration **without executing plugin
