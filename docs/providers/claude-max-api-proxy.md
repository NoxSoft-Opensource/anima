...
You can point Anima at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Anima
...
- [Anthropic provider](/providers/anthropic) - Native Anima integration with Claude setup-token or API keys
