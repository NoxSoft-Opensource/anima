---
summary: "Use NVIDIA's OpenAI-compatible API in Anima"
read_when:
  - You want to use NVIDIA models in Anima
...
anima onboard --auth-choice skip
anima models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
