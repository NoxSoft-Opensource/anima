---
summary: "Use Qianfan's unified API to access many models in Anima"
read_when:
...
3. Anima installed on your system
...
4. Copy the API key for use with Anima

## CLI setup

```bash
anima onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Anima Configuration](/gateway/configuration)
