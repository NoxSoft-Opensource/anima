---
summary: "Use Synthetic's Anthropic-compatible API in Anima"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Anima registers it as the
...
Note: Anima's Anthropic client appends `/v1` to the base URL, so use
