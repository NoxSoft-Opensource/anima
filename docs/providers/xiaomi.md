---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Anima"
read_when:
  - You want Xiaomi MiMo models in Anima
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Anima uses
