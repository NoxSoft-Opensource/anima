# Contributing to the Anima Threat Model

Thanks for helping make Anima more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of Anima are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [Anima Threat Model](./THREAT-MODEL-ATLAS.md)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Anima security hall of fame for significant contributions.
