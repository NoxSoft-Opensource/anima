...
This threat model documents adversarial threats to the Anima AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.
...
| **ClawHub**          | Anima's skill marketplace                              |
