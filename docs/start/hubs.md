---
summary: "Hubs that link to every Anima doc"
read_when:
...
<Note>
If you are new to Anima, start with [Getting Started](/start/getting-started).
</Note>
