---
summary: "Overview of Anima onboarding options and flows"
read_when:
...
Anima supports multiple onboarding paths depending on where the Gateway runs
...
- [`anima onboard` command](/cli/onboard)

## macOS app onboarding

Use the Anima app when you want a fully guided setup on macOS. Docs:
