---
summary: "First-run onboarding flow for Anima (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Anima">
...
<Step title="CLI">
  ...
  The app can install the global `anima` CLI via npm/pnpm so terminal
