...
Install the Lobster CLI on the **same host** that runs the Anima Gateway (see the [Lobster repo](https://github.com/anima/lobster)), and ensure `lobster` is on `PATH`.
