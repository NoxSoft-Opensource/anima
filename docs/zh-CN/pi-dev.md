...
本指南总结了在 Anima 中开发 Pi 集成的合理工作流程。
...
状态存储在 Anima 状态目录下。默认为 `~/.anima`。如果设置了 `ANIMA_STATE_DIR`，则使用该目录。
...
- https://docs.noxsoft.net/anima/testing
- https://docs.noxsoft.net/anima/start/getting-started
