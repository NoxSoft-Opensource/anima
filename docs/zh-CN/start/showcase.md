...
<Info>
**想要展示你的项目？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 分享或在 [X 上 @anima](https://x.com/anima)。
</Info>
...
<Card title="Bambu 3D 打印机控制" icon="print" href="https://animahub.com/tobiasbischoff/bambu-cli">
...
<Card title="维也纳交通 (Wiener Linien)" icon="train" href="https://animahub.com/hjanuschka/wienerlinien">
...
<Card title="R2 上传 (Send Me My Files)" icon="cloud-arrow-up" href="https://animahub.com/skills/r2-upload">
...
Anima 连接到 Jira，然后即时生成一个新的 skill（在它出现在 AnimaHub 之前）。
</Card>
...
<Card title="OpenRouter 转录" icon="microphone" href="https://animahub.com/obviyus/openrouter-transcribe">
  **@obviyus** • `transcription` `multilingual` `skill`

通过 OpenRouter（Gemini 等）进行多语言音频转录。可在 AnimaHub 获取。
</Card>
...
<Card title="Nix 打包" icon="snowflake" href="https://github.com/anima/nix-anima">
  **@anima** • `nix` `packaging` `deployment`
  
  开箱即用的 nixified Anima 配置，用于可复现的部署。
</Card>

<Card title="CalDAV 日历" icon="calendar" href="https://animahub.com/skills/caldav-calendar">
...
<Steps>
  <Step title="分享它">
    在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 发布或在 [Twitter 上 @anima](https://x.com/anima)
  </Step>
  <Step title="包含详细信息">
