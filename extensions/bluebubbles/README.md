...
This directory contains the **BlueBubbles external channel plugin** for Anima.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `anima/plugin-sdk` helpers.
