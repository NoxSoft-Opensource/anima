...
import { resolveChannelMediaMaxBytes, type AnimaConfig } from "anima/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AnimaConfig; accountId?: string }): string[] {
