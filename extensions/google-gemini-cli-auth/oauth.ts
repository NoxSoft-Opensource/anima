...
import { isWSL2Sync } from "anima/plugin-sdk";

const CLIENT_ID_KEYS = ["ANIMA_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = [
  "ANIMA_GEMINI_OAUTH_CLIENT_SECRET",
...
async function discoverProject(accessToken: string): Promise<string> {
  ...
  const headers = {
    ...
    "X-Goog-Api-Client": "gl-node/anima",
  };
