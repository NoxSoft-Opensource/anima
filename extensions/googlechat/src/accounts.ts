...
export function listGoogleChatAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AnimaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AnimaConfig): ResolvedGoogleChatAccount[] {
