...
export function listMattermostAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AnimaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AnimaConfig): ResolvedMattermostAccount[] {
