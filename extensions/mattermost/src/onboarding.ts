import type { ChannelOnboardingAdapter, AnimaConfig, WizardPrompter } from "anima/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.anima.ai/channels/mattermost",
    ].join("\n"),
