...
import type { ReplyPayload, AnimaConfig } from "anima/plugin-sdk";
import { createReplyPrefixOptions } from "anima/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AnimaConfig;
