...
- Version alignment with core Anima release numbers.
...
- First public release of the @anima/voice-call plugin.
...
- CLI: `anima voicecall` commands (call/start/continue/speak/end/status/tail/expose).
