...
export function listZalouserAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AnimaConfig): string {
...
function mergeZalouserAccountConfig(cfg: AnimaConfig, accountId: string): ZalouserAccountConfig {
