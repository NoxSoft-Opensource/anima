...
- Keep product names in English: Anima, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Anima Gateway, use “Gateway 网关”.
