...
# Output:
# - dist/Anima.app
# - dist/Anima-<version>.zip
# - dist/Anima-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Anima-$VERSION.zip"
DMG="$ROOT_DIR/dist/Anima-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Anima-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Anima-$VERSION.dSYM.zip"
