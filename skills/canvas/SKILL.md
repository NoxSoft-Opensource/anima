...
Display HTML content on connected ANIMA nodes (Mac app, iOS, Android).
...
```
http://<tailscale-hostname>:18793/__noxsoft__/canvas/<file>.html
```
...
Place files in the canvas root directory (default `~/anima/canvas/`):

```bash
cat > ~/anima/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
- **loopback**: `http://127.0.0.1:18793/__noxsoft__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__noxsoft__/canvas/<file>.html`
...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__noxsoft__/canvas/snake.html
```
...
The canvas host serves from `/__noxsoft__/canvas/` prefix:

```
http://<host>:18793/__noxsoft__/canvas/index.html  → ~/anima/canvas/index.html
http://<host>:18793/__noxsoft__/canvas/games/snake.html → ~/anima/canvas/games/snake.html
```

The `/__noxsoft__/canvas/` prefix is defined by `CANVAS_HOST_PATH` constant.
