...
export function listAgentIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultAgentId(cfg: AnimaConfig): string {
  const agents = listAgents(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
export function resolveSessionAgentIds(params: { sessionKey?: string; config?: AnimaConfig }): {
...
export function resolveAgentSkillsFilter(cfg: AnimaConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: AnimaConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: AnimaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: AnimaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
