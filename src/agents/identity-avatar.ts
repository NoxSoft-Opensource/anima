...
function resolveAvatarSource(cfg: AnimaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AnimaConfig, agentId: string): AgentAvatarResolution {
