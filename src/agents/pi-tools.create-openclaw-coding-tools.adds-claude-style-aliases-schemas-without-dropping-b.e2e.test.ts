...
describe("createAnimaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAnimaCodingTools({
      config,
    ...
    const anthropicTools = createAnimaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAnimaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAnimaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
