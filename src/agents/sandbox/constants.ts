...
export const DEFAULT_SANDBOX_IMAGE = "anima-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "anima-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "anima-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "anima-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "anima-sbx-browser-";
