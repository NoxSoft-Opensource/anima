...
function resolveMainSessionKeyForSandbox(params: { cfg?: AnimaConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: AnimaConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`anima sandbox explain --session ${runtime.sessionKey}`)}`);
