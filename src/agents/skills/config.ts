import type { AnimaConfig, SkillConfig } from "../../config/config.js";
...
export function isConfigPathTruthy(config: AnimaConfig | undefined, pathStr: string): boolean {
  return isConfigPathTruthyWithDefaults(config, pathStr, DEFAULT_CONFIG_VALUES);
}

export function resolveSkillConfig(
  config: AnimaConfig | undefined,
  skillKey: string,
...
export function resolveBundledAllowlist(config?: AnimaConfig): string[] | undefined {
