...
function resolveWatchPaths(workspaceDir: string, config?: AnimaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AnimaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AnimaConfig }) {
