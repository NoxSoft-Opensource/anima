...
function resolveForegroundMs(cfg: AnimaConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true in your Anima config. Docs: https://docs.noxsoft.net/anima/tools/slash-commands#config",
    };
  }
