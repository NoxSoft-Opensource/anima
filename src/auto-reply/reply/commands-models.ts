...
// Telegram model buttons removed — inline keyboard features are no longer available.
 ...
 */
export async function buildModelsProviderData(cfg: AnimaConfig): Promise<ModelsProviderData> {
