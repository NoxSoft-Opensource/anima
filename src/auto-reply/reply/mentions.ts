...
function resolveMentionPatterns(cfg: AnimaConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AnimaConfig | undefined, agentId?: string): RegExp[] {
