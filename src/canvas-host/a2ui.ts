...
export const A2UI_PATH = "/__anima__/a2ui";

export const CANVAS_HOST_PATH = "/__anima__/canvas";

export const CANVAS_WS_PATH = "/__anima__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.animaCanvasA2UIAction.postMessage(...)
  // - Android: window.animaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["animaCanvasA2UIAction"];
  ...
  globalThis.Anima = globalThis.Anima ?? {};
  globalThis.Anima.postMessage = postToNode;
  globalThis.Anima.sendUserAction = sendUserAction;
  globalThis.animaPostMessage = postToNode;
  globalThis.animaSendUserAction = sendUserAction;
