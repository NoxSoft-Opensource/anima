 ...
 */
const t$10 = globalThis,
  e$18 =
    t$10.ShadowRoot &&
    (void 0 === t$10.ShadyCSS || t$10.ShadyCSS.nativeShadow) &&
...
var n$17 = class {
  ...
  get styleSheet() {
    ...
    if (e$18 && void 0 === t) {
      ...
      (e && (t = o$18.get(s)),
        void 0 === t &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o$18.set(s, t)));
    }
    return t;
  }
  toString() {
...
const r$16 = (t) => new n$17("string" == typeof t ? t : t + "", void 0, s$12),
  i$14 = (t, ...e) => {
    const o =
      1 === t.length
        ? t[0]
 ...
 */ const {
    is: i$13,
    defineProperty: e$17,
    getOwnPropertyDescriptor: h$10,
    getOwnPropertyNames: r$15,
    getOwnPropertySymbols: o$17,
    getPrototypeOf: n$16,
  } = Object,
  a$3 = globalThis,
  c$11 = a$3.trustedTypes,
  l$7 = c$11 ? c$11.emptyScript : "",
...
var y$3 = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, s, i) {
    const { get: e, set: r } = h$10(this.prototype, t) ?? {
      get() {
        return this[s];
      },
      set(t) {
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? b$3;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (((this.finalized = !0), this._$Ei(), this.hasOwnProperty(d$5("properties")))) {
  ...
  static finalizeStyles(s) {
    ...
    if (Array.isArray(s)) {
      ...
      for (const s of e) i.unshift(c$12(s));
    } else void 0 !== s && i.push(c$12(s));
    return i;
  }
  static _$Eu(t, s) {
    const i = s.attribute;
  ...
  _$ET(t, s) {
    ...
    if (void 0 !== e && !0 === i.reflect) {
      const h = (void 0 !== i.converter?.toAttribute ? i.converter : u$7).toAttribute(s, i.type);
      ((this._$Em = t),
...
((y$3.elementStyles = []),
  (y$3.shadowRootOptions = { mode: "open" }),
  (y$3[d$5("elementProperties")] = new Map()),
  (y$3[d$5("finalized")] = new Map()),
  p$5?.({ ReactiveElement: y$3 }),
  (a$3.reactiveElementVersions ??= []).push("2.1.2"));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$9 = globalThis,
  i$12 = (t) => t,
  s$11 = t$9.trustedTypes,
  e$16 = s$11 ? s$11.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  h$9 = "$lit$",
  o$16 = `lit$${Math.random().toFixed(9).slice(2)}$`,
  n$15 = "?" + o$16,
  r$14 = `<${n$15}>`,
  l$6 = document,
  c$10 = () => l$6.createComment(""),
  a$2 = (t) => null === t || ("object" != typeof t && "function" != typeof t),
  u$6 = Array.isArray,
  d$4 = (t) => u$6(t) || "function" == typeof t?.[Symbol.iterator],
  f$6 = "[ 	\n\f\r]",
  v$3 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  _$1 = /-->/g,
  m$4 = />/g,
  p$4 = RegExp(`>|${f$6}(?:([^\\s"'>=/]+)(${f$6}*=${f$6}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"),
  g$1 = /'/g,
  $$1 = /"/g,
  ...
  w$1 = x$1(2),
  T$1 = x$1(3),
  E$1 = Symbol.for("lit-noChange"),
  A$1 = Symbol.for("lit-nothing"),
  C$1 = new WeakMap(),
  P$1 = l$6.createTreeWalker(l$6, 129);
function V$1(t, i) {
  if (!u$6(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
        ...
        c === v$3
          ? "!--" === u[1]
            ...
            : void 0 !== u[1]
              ? (c = m$4)
              : void 0 !== u[2]
                ? (y$2.test(u[2]) && (n = RegExp("</" + u[2], "g")), (c = p$4))
                : void 0 !== u[3] && (c = p$4)
          : c === p$4
            ? ">" === u[0]
              ? ((c = n ?? v$3), (d = -1))
              : void 0 === u[1]
                ...
                : ((d = c.lastIndex - u[2].length),
                  (a = u[1]),
                  (c = void 0 === u[3] ? p$4 : '"' === u[3] ? $$1 : g$1))
            : c === $$1 || c === g$1
              ? (c = p$4)
              : c === _$1 || c === m$4
                ? (c = v$3)
                : ((c = p$4), (n = void 0)));
    const x = c === p$4 && t[i + 1].startsWith("/>") ? " " : "";
    l +=
      c === v$3
        ? s + r$14
        : d >= 0
          ? (e.push(a), s.slice(0, d) + h$9 + s.slice(d) + o$16 + x)
          : s + o$16 + (-2 === d ? i : x);
  }
  return [V$1(t, l + (t[s] || "<?>") + (2 === i ? "</svg>" : 3 === i ? "</math>" : "")), e];
};
var S$2 = class S$2 {
  constructor({ strings: t, _$litType$: i }, e) {
    ...
    const u = t.length - 1,
      ...
      [f, v] = N$1(t, i);
    if (
      ((this.el = S$2.createElement(f, e)), (P$1.currentNode = this.el.content), 2 === i || 3 === i)
    ) {
    ...
    for (; null !== (r = P$1.nextNode()) && d.length < u; ) {
      if (1 === r.nodeType) {
          ...
          for (const t of r.getAttributeNames())
            if (t.endsWith(h$9)) {
              ...
              (d.push({
                ...
                name: e[2],
                strings: s,
                ctor: "." === e[1] ? I$1 : "?" === e[1] ? L$1 : "@" === e[1] ? z$1 : H$1,
              }),
                r.removeAttribute(t));
            } else
              t.startsWith(o$16) &&
                ...
                r.removeAttribute(t));
        if (y$2.test(r.tagName)) {
          const t = r.textContent.split(o$16),
            i = t.length - 1;
          if (i > 0) {
            r.textContent = s$11 ? s$11.emptyScript : "";
            for (let s = 0; s < i; s++)
              (r.append(t[s], c$10()),
                P$1.nextNode(),
                d.push({
        ...
        if (r.data === n$15)
          ...
          let t = -1;
          for (; -1 !== (t = r.data.indexOf(o$16, t + 1)); )
            (d.push({
              type: 7,
              index: l,
            }),
  ...
  static createElement(t, i) {
    const s = l$6.createElement("template");
    return ((s.innerHTML = t), s);
  }
};
function M$3(t, i, s = t, e) {
  if (i === E$1) return i;
  let h = void 0 !== e ? s._$Co?.[e] : s._$Cl;
  const o = a$2(i) ? void 0 : i._$litDirective$;
  return (
    h?.constructor !== o &&
      (h?._$AO?.(!1),
      void 0 === o ? (h = void 0) : ((h = new o(t)), h._$AT(t, s, e)),
      void 0 !== e ? ((s._$Co ??= [])[e] = h) : (s._$Cl = h)),
    void 0 !== h && (i = M$3(t, h._$AS(t, i.values), h, e)),
    i
  );
}
var R$1 = class {
  ...
  u(t) {
    const {
      ...
      e = (t?.creationScope ?? l$6).importNode(i, !0);
    P$1.currentNode = e;
    let h = P$1.nextNode(),
      o = 0,
      n = 0,
    ...
    for (; void 0 !== r; ) {
      if (o === r.index) {
        let i;
        (2 === r.type
          ? (i = new k$1(h, h.nextSibling, this, t))
          : 1 === r.type
            ? (i = new r.ctor(h, r.name, r.strings, this, t))
            : 6 === r.type && (i = new Z$1(h, this, t)),
          this._$AV.push(i),
          (r = s[++n]));
      }
      o !== r?.index && ((h = P$1.nextNode()), o++);
    }
    return ((P$1.currentNode = l$6), e);
  }
  p(t) {
    let i = 0;
...
var k$1 = class k$1 {
  ...
  _(t) {
    (this._$AH !== A$1 && a$2(this._$AH)
      ? (this._$AA.nextSibling.data = t)
      : this.T(l$6.createTextNode(t)),
      (this._$AH = t));
  }
  $(t) {
    const { values: i, _$litType$: s } = t,
      e =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el && (s.el = S$2.createElement(V$1(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === e) this._$AH.p(i);
    else {
      const t = new R$1(e, this),
        s = t.u(this.options);
  ...
  _$AC(t) {
    ...
    return (void 0 === i && C$1.set(t.strings, (i = new S$2(t))), i);
  }
  k(t) {
    u$6(this._$AH) || ((this._$AH = []), this._$AR());
    const i = this._$AH;
    let s,
      e = 0;
    for (const h of t)
      (e === i.length
        ? i.push((s = new k$1(this.O(c$10()), this.O(c$10()), this, this.options)))
        : (s = i[e]),
        s._$AI(h),
        e++);
...
var H$1 = class {
  ...
  _$AI(t, i = this, s, e) {
    ...
    if (void 0 === h)
      ((t = M$3(this, t, i, 0)),
        (o = !a$2(t) || (t !== this._$AH && t !== E$1)),
        o && (this._$AH = t));
    else {
      const e = t;
      let n, r;
      for (t = h[0], n = 0; n < h.length - 1; n++)
        ((r = M$3(this, e[s + n], i, n)),
          r === E$1 && (r = this._$AH[n]),
          (o ||= !a$2(r) || r !== this._$AH[n]),
          r === A$1 ? (t = A$1) : t !== A$1 && (t += (r ?? "") + h[n + 1]),
          (this._$AH[n] = r));
    }
    o && !e && this.j(t);
  }
...
var z$1 = class extends H$1 {
  constructor(t, i, s, e, h) {
    (super(t, i, s, e, h), (this.type = 5));
  }
  _$AI(t, i = this) {
    if ((t = M$3(this, t, i, 0) ?? A$1) === E$1) return;
    const s = this._$AH,
      e =
        (t === A$1 && s !== A$1) ||
        t.capture !== s.capture ||
...
const j$2 = {
  ...
  B$1 = t$9.litHtmlPolyfillSupport;
(B$1?.(S$2, k$1), (t$9.litHtmlVersions ??= []).push("3.3.2"));
const D = (t, i, s) => {
  const e = s?.renderBefore ?? i;
  let h = e._$litPart$;
  if (void 0 === h) {
    const t = s?.renderBefore ?? null;
    e._$litPart$ = h = new k$1(i.insertBefore(c$10(), t), t, void 0, s ?? {});
  }
  return (h._$AI(t), h);
};
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const s$10 = globalThis;
var i$11 = class extends y$3 {
  constructor() {
...
((i$11._$litElement$ = !0),
  (i$11["finalized"] = !0),
  s$10.litElementHydrateSupport?.({ LitElement: i$11 }));
const o$15 = s$10.litElementPolyfillSupport;
o$15?.({ LitElement: i$11 });
const n$14 = {
  _$AK: (t, e, r) => {
    t._$AK(e, r);
  },
...
(s$10.litElementVersions ??= []).push("4.2.2");
 ...
 */ const { I: t$7 } = j$2,
  i$9 = (o) => o,
  n$13 = (o) => null === o || ("object" != typeof o && "function" != typeof o),
  e$14 = {
    HTML: 1,
    SVG: 2,
    MATHML: 3,
  },
  l$5 = (o, t) => (void 0 === t ? void 0 !== o?._$litType$ : o?._$litType$ === t),
  d$3 = (o) => null != o?._$litType$?.h,
  c$9 = (o) => void 0 !== o?._$litDirective$,
  f$5 = (o) => o?._$litDirective$,
  r$13 = (o) => void 0 === o.strings,
  s$9 = () => document.createComment(""),
  v$2 = (o, n, e) => {
    const l = o._$AA.parentNode,
      d = void 0 === n ? o._$AB : n._$AA;
    if (void 0 === e) {
      const i = l.insertBefore(s$9(), d),
        n = l.insertBefore(s$9(), d);
      e = new t$7(i, n, o, o.options);
    } else {
      ...
      if (t !== d || c) {
        let o = e._$AA;
        for (; o !== t; ) {
          const t = i$9(o).nextSibling;
          (i$9(l).insertBefore(o, d), (o = t));
        }
      }
    }
    return e;
  },
  u$5 = (o, t, i = o) => (o._$AI(t, i), o),
  m$3 = {},
  p$3 = (o, t = m$3) => (o._$AH = t),
  M$2 = (o) => o._$AH,
  h$8 = (o) => {
    ...
    class extends i$10 {
      ...
      update(s, [t, r, c]) {
        ...
        for (; x <= j && k <= w; )
          ...
          else if (h[x] === a[k]) ((v[k] = u$5(d[x], p[k])), x++, k++);
          else if (h[j] === a[w]) ((v[w] = u$5(d[j], p[w])), j--, w--);
          else if (h[x] === a[w]) ((v[w] = u$5(d[x], p[w])), v$2(s, v[w + 1], d[x]), x++, w--);
          else if (h[j] === a[k]) ((v[k] = u$5(d[j], p[k])), v$2(s, d[x], d[j]), j--, k++);
          else if ((void 0 === m && ((m = u$4(a, k, w)), (y = u$4(h, x, j))), m.has(h[x])))
            if (m.has(h[j])) {
              const e = y.get(a[k]),
                t = void 0 !== e ? d[e] : null;
              if (null === t) {
                const e = v$2(s, d[x]);
                (u$5(e, p[k]), (v[k] = e));
              } else ((v[k] = u$5(t, p[k])), v$2(s, d[x], t), (d[e] = null));
              k++;
            } else (h$8(d[j]), j--);
          else (h$8(d[x]), x++);
        for (; k <= w; ) {
 ...
 */ var s$7 = class {
  ...
  dispatchRequest() {
    this.host.dispatchEvent(new s$8(this.context, this.host, this.t, this.subscribe));
  }
};
...
var i$8 = class extends s$6 {
    ...
    (super(void 0 !== e.context ? e.initialValue : i),
      ...
      (this.onProviderRequest = (s) => {
        ...
        for (const [s, { consumerHost: i }] of this.subscriptions)
          e.has(s) || (e.add(s), i.dispatchEvent(new s$8(this.context, i, s, !0)));
        s.stopPropagation();
      }),
      (this.host = s),
  ...
  hostConnected() {
    this.host.dispatchEvent(new e$13(this.context, this.host));
  }
};
    ...
    ((this.pendingContextRequests = new Map()),
      (this.onContextProvider = (t) => {
        ...
        for (const { elementRef: s, callbackRef: n } of o) {
          const o = s.deref(),
            c = n.deref();
          void 0 === o || void 0 === c || o.dispatchEvent(new s$8(t.context, o, c, !0));
        }
      }),
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ function c$7({ context: c, subscribe: e }) {
  return (o, n) => {
    "object" == typeof n
...
function producerAccessed$1(node) {
  ...
  if (activeConsumer$1.producerNode[idx] !== node) {
    ...
    activeConsumer$1.producerIndexOfThis[idx] = consumerIsLive$1(activeConsumer$1)
      ? producerAddLiveConsumer$1(node, activeConsumer$1, idx)
      : 0;
  }
...
((Signal2) => {
  ...
  ((subtle2) => {
    ...
    function introspectSinks(signal) {
      ...
      return (
        ((_a3 = signal[NODE$1].liveConsumerNode) == null ? void 0 : _a3.map((n) => n.wrapper)) ?? []
      );
    }
...
var n$11 = class {
  ...
  get styleSheet() {
    ...
    if (e$11 && void 0 === t) {
      ...
      (e && (t = o$13.get(s)),
        void 0 === t &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o$13.set(s, t)));
    }
    return t;
  }
  toString() {
...
const r$12 = (t) => new n$11("string" == typeof t ? t : t + "", void 0, s$5),
  i$7 = (t, ...e) => {
    const o =
      1 === t.length
        ? t[0]
 ...
 */ const {
    ...
    getOwnPropertyNames: r$11,
    getOwnPropertySymbols: o$12,
    getPrototypeOf: n$10,
  } = Object,
  a$1 = globalThis,
  ...
  requestUpdate(t, s, i) {
    if (void 0 !== t) {
      ...
      if (
        ...
        !(
          (i.hasChanged ?? f$4)(h, s) ||
          (i.useDefault && i.reflect && h === this._$Ej?.get(t) && !this.hasAttribute(e._$Eu(t, i)))
        ))
      )
        return;
      this.C(t, s, i);
...
function r$8(r) {
  return (n, o) =>
    e$9(n, o, {
      get() {
        return (this.renderRoot ?? (e$7 ??= document.createDocumentFragment())).querySelectorAll(r);
      },
    });
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ let i$5 = !1;
const s$4 = new Signal.subtle.Watcher(() => {
    i$5 ||
      ((i$5 = !0),
      queueMicrotask(() => {
        i$5 = !1;
        for (const t of s$4.getPending()) t.get();
        s$4.watch();
      }));
  }),
  h$6 = Symbol("SignalWatcherBrand"),
  e$6 = new FinalizationRegistry((i) => {
 ...
 */ const s$3 = (i, t) => {
    ...
    for (const i of e) (i._$AO?.(t, !1), s$3(i, t));
    return !0;
  },
  o$8 = (i) => {
    let t, e;
...
function n$6(i, t = !1, e = 0) {
  const r = this._$AH,
    h = this._$AN;
  if (void 0 !== h && 0 !== h.size)
    if (t)
      if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s$3(r[i], !1), o$8(r[i]));
      else null != r && (s$3(r, !1), o$8(r));
    else s$3(this, i);
}
const c$4 = (i) => {
  i.type == t$8.CHILD && ((i._$AP ??= n$6), (i._$AQ ??= h$5));
};
var f$3 = class extends i$10 {
  constructor() {
  ...
  _$AO(i, t = !0) {
    (i !== this.isConnected &&
      ...
      t && (s$3(this, i), o$8(this)));
  }
  setValue(t) {
    if (r$13(this._$Ct)) this._$Ct._$AI(t, this);
    else {
 ...
 */
let o$7 = !1;
const n$5 = new Signal.subtle.Watcher(async () => {
  o$7 ||
    ((o$7 = !0),
    queueMicrotask(() => {
      o$7 = !1;
      for (const i of n$5.getPending()) i.get();
      n$5.watch();
    }));
});
var r$5 = class extends f$3 {
  _$S_() {
    var i, t;
    void 0 === this._$Sm &&
 ...
 */ const m$2 =
    ...
    (t, ...m) =>
      o(
        t,
        ...m.map((o) => (o instanceof Signal.State || o instanceof Signal.Computed ? h$4(o) : o)),
      ),
  l$3 = m$2(b$2),
  r$4 = m$2(w$1);
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const l$2 = Signal.State,
  o$6 = Signal.Computed,
  r$3 = (l, o) => new Signal.State(l, o),
  i$4 = (l, o) => new Signal.Computed(l, o);
...
const themeContext = n$12("A2UITheme");

const structuralStyles = r$16(structuralStyles$1);
...
let Root = (() => {
  ...
  var Root = class extends _classSuper {
    ...
    static {
      ...
      _theme_decorators = [c$7({ context: themeContext })];
    ...
    renderComponentTree(components) {
      ...
      return b$2` ${o$5(components, (component) => {
        ...
        switch (component.type) {
          case "List": {
            ...
            return b$2`<a2ui-list
            id=${node.id}
            slot=${node.slotName ? node.slotName : A$1}
            .component=${node}
          ...
          case "MultipleChoice": {
            const node = component;
            return b$2`<a2ui-multiplechoice
            id=${node.id}
            slot=${node.slotName ? node.slotName : A$1}
            .component=${node}
            .weight=${node.weight ?? "initial"}
    ...
    renderCustomComponent(component) {
      ...
      const elCtor = registeredCtor || customElements.get(component.type);
      if (!elCtor) {
        return b$2`Unknown element ${component.type}`;
      }
      const el = new elCtor();
      el.id = node.id;
      if (node.slotName) {
...
const t$2 = globalThis,
  ...
  s$2 = i$3 ? i$3.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  e$5 = "$lit$",
  ...
  for (let i = 0; i < s; i++) {
    ...
    l +=
      c === f$2
        ? s + n$4
        : d >= 0
          ? (o.push(a), s.slice(0, d) + e$5 + s.slice(d) + h$3 + x)
          : s + h$3 + (-2 === d ? i : x);
  }
...
var k = class {
  ...
  _$AI(t, i = this, s, e) {
    ...
    let o = !1;
    if (void 0 === h)
      ((t = S(this, t, i, 0)), (o = !c$3(t) || (t !== this._$AH && t !== T)), o && (this._$AH = t));
    else {
      const e = t;
      let n, r;
      for (t = h[0], n = 0; n < h.length - 1; n++)
      ...
      update(e, [r]) {
        ...
        for (const t in r) {
          ...
          if (null != e) {
            ...
            t.includes("-") || r
              ? s.setProperty(t, r ? e.slice(0, -11) : e, r ? n$3 : "")
              : (s[t] = e);
          }
        }
        return T;
...
let Audio = (() => {
  ...
  var Audio = class extends _classSuper {
    ...
    #renderAudio() {
      ...
      if (this.url && typeof this.url === "object") {
        if ("literalString" in this.url) {
          return b$2`<audio controls src=${this.url.literalString} />`;
        } else if ("literal" in this.url) {
          return b$2`<audio controls src=${this.url.literal} />`;
        } else if (this.url && "path" in this.url && this.url.path) {
          if (!this.processor || !this.component) {
            return b$2`(no processor)`;
          }
          ...
          if (!audioUrl) {
            return b$2`Invalid audio URL`;
          }
          if (typeof audioUrl !== "string") {
            return b$2`Invalid audio URL`;
          }
          return b$2`<audio controls src=${audioUrl} />`;
        }
      }
      return b$2`(empty)`;
    }
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.AudioPlayer)}
      style=${this.theme.additionalStyles?.AudioPlayer ? o$3(this.theme.additionalStyles?.AudioPlayer) : A$1}
    >
      ${this.#renderAudio()}
    </section>`;
    }
...
let Button = (() => {
  ...
  var Button = class extends _classSuper {
    ...
    render() {
      return b$2`<button
      class=${e$3(this.theme.components.Button)}
      style=${this.theme.additionalStyles?.Button ? o$3(this.theme.additionalStyles?.Button) : A$1}
      @click=${() => {
        if (!this.action) {
          return;
        }
...
let Card = (() => {
  ...
  var Card = class extends _classSuper {
    ...
    render() {
      return b$2` <section
      class=${e$3(this.theme.components.Card)}
      style=${this.theme.additionalStyles?.Card ? o$3(this.theme.additionalStyles?.Card) : A$1}
    >
      <slot></slot>
    </section>`;
    }
...
let Checkbox = (() => {
  ...
  var Checkbox = class extends _classSuper {
    ...
    #renderField(value) {
      return b$2` <section
      class=${e$3(this.theme.components.CheckBox.container)}
      style=${this.theme.additionalStyles?.CheckBox ? o$3(this.theme.additionalStyles?.CheckBox) : A$1}
    >
      <input
        class=${e$3(this.theme.components.CheckBox.element)}
        autocomplete="off"
        @input=${(evt) => {
        ...
        .value=${value}
      />
      <label class=${e$3(this.theme.components.CheckBox.label)} for="data"
...
let Column = (() => {
  ...
  var Column = class extends _classSuper {
    ...
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.Column)}
      style=${this.theme.additionalStyles?.Column ? o$3(this.theme.additionalStyles?.Column) : A$1}
    >
      <slot></slot>
    </section>`;
    }
...
let DateTimeInput = (() => {
  ...
  var DateTimeInput = class extends _classSuper {
    ...
    #renderField(value) {
      return b$2`<section
      class=${e$3(this.theme.components.DateTimeInput.container)}
    >
      <label
        for="data"
        class=${e$3(this.theme.components.DateTimeInput.label)}
        >${this.#getPlaceholderText()}</label
      >
      <input
        autocomplete="off"
        class=${e$3(this.theme.components.DateTimeInput.element)}
        style=${this.theme.additionalStyles?.DateTimeInput ? o$3(this.theme.additionalStyles?.DateTimeInput) : A$1}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
...
let Divider = (() => {
  ...
  var Divider = class extends _classSuper {
    ...
    render() {
      return b$2`<hr
      class=${e$3(this.theme.components.Divider)}
      style=${this.theme.additionalStyles?.Divider ? o$3(this.theme.additionalStyles?.Divider) : A$1}
    />`;
    }
    static {
  ...
  var Icon = class extends _classSuper {
    ...
    #renderIcon() {
      ...
      const render = (url) => {
        ...
        return b$2`<span class="g-icon">${url}</span>`;
      };
    ...
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.Icon)}
      style=${this.theme.additionalStyles?.Icon ? o$3(this.theme.additionalStyles?.Icon) : A$1}
    >
      ${this.#renderIcon()}
    </section>`;
    }
...
let List = (() => {
  ...
  var List = class extends _classSuper {
    ...
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.List)}
      style=${this.theme.additionalStyles?.List ? o$3(this.theme.additionalStyles?.List) : A$1}
    >
      <slot></slot>
    </section>`;
    }
...
let MultipleChoice = (() => {
  ...
  var MultipleChoice = class extends _classSuper {
    ...
    render() {
      return b$2`<section class=${e$3(this.theme.components.MultipleChoice.container)}>
      <label class=${e$3(this.theme.components.MultipleChoice.label)} for="data">${this.description ?? "Select an item"}</div>
      <select
        name="data"
        id="data"
        class=${e$3(this.theme.components.MultipleChoice.element)}
        style=${this.theme.additionalStyles?.MultipleChoice ? o$3(this.theme.additionalStyles?.MultipleChoice) : A$1}
        @change=${(evt) => {
      ...
      >
        ${this.options.map((option) => {
          ...
          return b$2`<option ${option.value}>${label}</option>`;
        })}
      </select>
    </section>`;
    }
 ...
 */ const { I: t } = Z,
  ...
  e$2 = (o, t) => (void 0 === t ? void 0 !== o?._$litType$ : o?._$litType$ === t),
  l = (o) => null != o?._$litType$?.h,
  d = (o) => void 0 !== o?._$litDirective$,
  c$2 = (o) => o?._$litDirective$,
  f$1 = (o) => void 0 === o.strings,
  r$1 = () => document.createComment(""),
  s$1 = (o, i, n) => {
    const e = o._$AA.parentNode,
      l = void 0 === i ? o._$AB : i._$AA;
    if (void 0 === n) {
      const i = e.insertBefore(r$1(), l),
        d = e.insertBefore(r$1(), l);
...
function n$1(i, t = !1, e = 0) {
  ...
  if (void 0 !== h && 0 !== h.size)
    if (t)
      if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s(r[i], !1), o$2(r[i]));
...
let Modal = (() => {
  ...
  var Modal = class extends _classSuper {
    ...
    static {
      const _metadata =
        typeof Symbol === "function" && Symbol.metadata
          ? Object.create(_classSuper[Symbol.metadata] ?? null)
          : void 0;
      _private_showModal_decorators = [r$9()];
      _private_modalRef_decorators = [e$8("dialog")];
      __esDecorate$7(
        this,
    ...
    render() {
      ...
      return b$2`<dialog
      class=${e$3(this.theme.components.Modal.backdrop)}
      @click=${(evt) => {
    ...
    >
      <section
        class=${e$3(this.theme.components.Modal.element)}
        style=${this.theme.additionalStyles?.Modal ? o$3(this.theme.additionalStyles?.Modal) : A$1}
      >
        <div id="controls">
          <button
            @click=${() => {
...
let Row = (() => {
  ...
  var Row = class extends _classSuper {
    ...
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.Row)}
      style=${this.theme.additionalStyles?.Row ? o$3(this.theme.additionalStyles?.Row) : A$1}
    >
      <slot></slot>
    </section>`;
    }
...
let Slider = (() => {
  ...
  var Slider = class extends _classSuper {
    ...
    #renderField(value) {
      return b$2`<section
      class=${e$3(this.theme.components.Slider.container)}
    >
      <label class=${e$3(this.theme.components.Slider.label)} for="data">
        ${this.label?.literalString ?? ""}
      </label>
      <input
        autocomplete="off"
        class=${e$3(this.theme.components.Slider.element)}
        style=${this.theme.additionalStyles?.Slider ? o$3(this.theme.additionalStyles?.Slider) : A$1}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
        ...
        max=${this.maxValue ?? "0"}
      />
      <span class=${e$3(this.theme.components.Slider.label)}
...
let Surface = (() => {
  ...
  var Surface = class extends _classSuper {
    ...
    #renderLogo() {
      ...
      return b$2`<div id="surface-logo">
    ...
    render() {
      ...
      return b$2`${[this.#renderLogo(), this.#renderSurface()]}`;
    }
    constructor() {
      super(...arguments);
...
const u = (e, s, t) => {
  ...
  c = e$4(
    class extends i$2 {
      ...
      update(s, [t, r, c]) {
        const d = p(s),
          { values: p$6, keys: a } = this.dt(t, r, c);
        if (!Array.isArray(d)) return ((this.ut = a), p$6);
        const h = (this.ut ??= []),
          v$4 = [];
        let m$5,
          y,
        ...
        for (; x <= j && k <= w; )
          ...
          else if (h[x] === a[k]) ((v$4[k] = v(d[x], p$6[k])), x++, k++);
          else if (h[j] === a[w]) ((v$4[w] = v(d[j], p$6[w])), j--, w--);
          else if (h[x] === a[w]) ((v$4[w] = v(d[x], p$6[w])), s$1(s, v$4[w + 1], d[x]), x++, w--);
          else if (h[j] === a[k]) ((v$4[k] = v(d[j], p$6[k])), s$1(s, d[x], d[j]), j--, k++);
          else if ((void 0 === m$5 && ((m$5 = u(a, k, w)), (y = u(h, x, j))), m$5.has(h[x])))
            if (m$5.has(h[j])) {
              const e = y.get(a[k]),
                t = void 0 !== e ? d[e] : null;
              if (null === t) {
                const e = s$1(s, d[x]);
                (v(e, p$6[k]), (v$4[k] = e));
              } else ((v$4[k] = v(t, p$6[k])), s$1(s, d[x], t), (d[e] = null));
              k++;
            } else (M(d[j]), j--);
          else (M(d[x]), x++);
        for (; k <= w; ) {
          const e = s$1(s, v$4[w + 1]);
          (v(e, p$6[k]), (v$4[k++] = e));
        }
        for (; x <= j; ) {
          const e = d[x++];
...
let Tabs = (() => {
  ...
  var Tabs = class extends _classSuper {
    ...
    #renderTabs() {
      ...
      return b$2`<div
      id="buttons"
      class=${e$3(this.theme.components.Tabs.element)}
    >
      ${c(this.titles, (title, idx) => {
        let titleString = "";
    ...
    #renderSlot() {
      return b$2`<slot name="current"></slot>`;
    }
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.Tabs.container)}
      style=${this.theme.additionalStyles?.Tabs ? o$3(this.theme.additionalStyles?.Tabs) : A$1}
    >
...
let TextField = (() => {
  ...
  var TextField = class extends _classSuper {
    ...
    #renderField(value, label) {
      return b$2` <section
      class=${e$3(this.theme.components.TextField.container)}
    >
      ${
        label && label !== ""
          ? b$2`<label
            class=${e$3(this.theme.components.TextField.label)}
            for="data"
            >${label}</label
          >`
          : A$1
      ...
      <input
        autocomplete="off"
        class=${e$3(this.theme.components.TextField.element)}
        style=${this.theme.additionalStyles?.TextField ? o$3(this.theme.additionalStyles?.TextField) : A$1}
        @input=${(evt) => {
          if (!(evt.target instanceof HTMLInputElement)) {
            return;
          }
...
var MarkdownDirective = class extends i$2 {
...
const markdown = e$4(MarkdownDirective);
...
let Text = (() => {
  ...
  var Text = class extends _classSuper {
    ...
    render() {
      ...
      return b$2`<section
      class=${e$3(classes)}
      style=${this.theme.additionalStyles?.Text ? o$3(this.#getAdditionalStyles()) : A$1}
    >
      ${this.#renderText()}
    </section>`;
    }
...
let Video = (() => {
  ...
  var Video = class extends _classSuper {
    ...
    #renderVideo() {
      ...
      if (this.url && typeof this.url === "object") {
        if ("literalString" in this.url) {
          return b$2`<video controls src=${this.url.literalString} />`;
        } else if ("literal" in this.url) {
          return b$2`<video controls src=${this.url.literal} />`;
        } else if (this.url && "path" in this.url && this.url.path) {
          if (!this.processor || !this.component) {
            return b$2`(no processor)`;
          }
          ...
          if (!videoUrl) {
            return b$2`Invalid video URL`;
          }
          if (typeof videoUrl !== "string") {
            return b$2`Invalid video URL`;
          }
          return b$2`<video controls src=${videoUrl} />`;
        }
      }
      return b$2`(empty)`;
    }
    render() {
      return b$2`<section
      class=${e$3(this.theme.components.Video)}
      style=${this.theme.additionalStyles?.Video ? o$3(this.theme.additionalStyles?.Video) : A$1}
    >
      ${this.#renderVideo()}
    </section>`;
    }
...
var AnimaA2UIHost = class extends i$11 {
  static properties = {
    surfaces: { state: true },
  ...
  themeProvider = new i$8(this, {
    context: themeContext,
    initialValue: animaTheme,
  });
  surfaces = [];
  pendingAction = null;
  toast = null;
  ...
  static styles = i$14`
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--anima-a2ui-inset-top, 0px)
        var(--anima-a2ui-inset-right, 0px)
        var(--anima-a2ui-inset-bottom, 0px)
        var(--anima-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--anima-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--anima-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
      ...
      pointer-events: none;
      backdrop-filter: blur(${r$16(statusBlur)});
      -webkit-backdrop-filter: blur(${r$16(statusBlur)});
      box-shadow: ${r$16(statusShadow)};
      z-index: 5;
    }
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--anima-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--anima-a2ui-empty-top, var(--anima-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.animaA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["anima:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__animaLastA2UIAction = userAction;
    const handler =
      globalThis.webkit?.messageHandlers?.animaCanvasA2UIAction ?? globalThis.animaCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        if (handler === globalThis.animaCanvasA2UIAction) {
      ...
      this.pendingAction?.phase === "sent"
        ...
        : this.pendingAction?.phase === "sending"
          ...
          : this.pendingAction?.phase === "error"
            ...
            : "";
    return b$2`
      ${this.pendingAction && this.pendingAction.phase !== "error" ? b$2`<div class="status"><div class="spinner"></div><div>${statusText}</div></div>` : ""}
      ${this.toast ? b$2`<div class="toast ${this.toast.kind === "error" ? "error" : ""}">${this.toast.text}</div>` : ""}
      <section id="surfaces">
      ${c$8(
        this.surfaces,
        ([surfaceId]) => surfaceId,
        ([surfaceId, surface]) => b$2`<a2ui-surface
          .surfaceId=${surfaceId}
          .surface=${surface}
          .processor=${this.#processor}
        ></a2ui-surface>`,
...
if (!customElements.get("anima-a2ui-host")) {
  customElements.define("anima-a2ui-host", AnimaA2UIHost);
}
