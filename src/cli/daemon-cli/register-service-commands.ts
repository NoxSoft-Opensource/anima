...
export function addGatewayServiceCommands(parent: Command, opts?: { statusDescription?: string }) {
  parent
    .command("status")
    .description(opts?.statusDescription ?? "Show Gateway service status and probe health")
  ...
  parent
    .command("start")
    .description("Start the Gateway system service")
    .option("--json", "Output JSON", false)
    .action(async (cmdOpts) => {
  ...
  parent
    .command("stop")
    .description("Stop the Gateway system service")
    .option("--json", "Output JSON", false)
    .action(async (cmdOpts) => {
  ...
  parent
    .command("restart")
    .description("Restart the Gateway system service")
    .option("--json", "Output JSON", false)
    .action(async (cmdOpts) => {
