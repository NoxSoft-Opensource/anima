...
const SANDBOX_EXAMPLES = {
  main: [
    ["anima sandbox list", "List all sandbox containers."],
    ["anima sandbox list --browser", "List only browser containers."],
    ["anima sandbox recreate --all", "Recreate all containers."],
    ["anima sandbox recreate --session main", "Recreate a specific session."],
    ["anima sandbox recreate --agent mybot", "Recreate agent containers."],
    ["anima sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["anima sandbox list", "List all sandbox containers."],
    ["anima sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["anima sandbox recreate --all", "Recreate all containers."],
    ["anima sandbox recreate --session main", "Recreate a specific session."],
    ["anima sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["anima sandbox recreate --browser --all", "Recreate only browser containers."],
    ["anima sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["anima sandbox explain", "Show effective sandbox config."],
    ["anima sandbox explain --session agent:main:main", "Explain a specific session."],
    ["anima sandbox explain --agent work", "Explain an agent sandbox."],
    ["anima sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.noxsoft.net/anima/cli/sandbox")}\n`,
    )
    .action(() => {
