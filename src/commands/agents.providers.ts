...
function resolveDefaultAccountId(cfg: AnimaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AnimaConfig): boolean {
...
export function summarizeBindings(cfg: AnimaConfig, bindings: AgentBinding[]): string[] {
