...
export async function gatewayStatusCommand(
  ...
  if (multipleGateways) {
    warnings.push({
      ...
      message:
        "Unconventional setup: multiple reachable gateways detected. Usually one gateway per network is recommended unless you intentionally run isolated profiles, like a rescue bot (see docs: https://docs.noxsoft.net/anima/gateway#multiple-gateways-same-host).",
