...
function resolveAnthropicDefaultAuthMode(cfg: AnimaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AnimaConfig): AnimaConfig {
...
export function applyTalkApiKey(config: AnimaConfig): AnimaConfig {
...
export function applyModelDefaults(cfg: AnimaConfig): AnimaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AnimaConfig): AnimaConfig {
...
export function applyLoggingDefaults(cfg: AnimaConfig): AnimaConfig {
...
export function applyContextPruningDefaults(cfg: AnimaConfig): AnimaConfig {
...
export function applyCompactionDefaults(cfg: AnimaConfig): AnimaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
