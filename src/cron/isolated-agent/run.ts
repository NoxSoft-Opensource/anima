...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/anima/anima/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  // correct per-agent paths (e.g. ~/.anima/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AnimaConfig = {
    ...params.cfg,
  ...
  if (requestedModelOverride !== undefined && requestedModelOverride.length > 0) {
