...
export function resolveHooksConfig(cfg: AnimaConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: AnimaConfig, defaultAgentId: string): Set<string> {
