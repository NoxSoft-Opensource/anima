 ...
 *
 * @see https://github.com/anima/anima/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an AnimaConfig.
 */
export function timestampOptsFromConfig(cfg: AnimaConfig): TimestampInjectionOptions {
  return {
