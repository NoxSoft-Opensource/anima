...
function listConfiguredAgentIds(cfg: AnimaConfig): string[] {
...
export function listAgentsForGateway(cfg: AnimaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AnimaConfig): string {
...
function resolveSessionStoreAgentId(cfg: AnimaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AnimaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AnimaConfig): GatewaySessionsDefaults {
