...
import type { AnimaPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AnimaPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AnimaPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
