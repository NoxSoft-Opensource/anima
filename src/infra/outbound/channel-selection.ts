...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: AnimaConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: AnimaConfig): Promise<MessageChannelId[]> {
