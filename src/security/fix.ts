...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AnimaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AnimaConfig; env: NodeJS.ProcessEnv }): {
  cfg: AnimaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
