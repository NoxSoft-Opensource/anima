...
export function listSignalAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AnimaConfig): string {
...
function mergeSignalAccountConfig(cfg: AnimaConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AnimaConfig): ResolvedSignalAccount[] {
