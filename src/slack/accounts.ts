...
export function listSlackAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: AnimaConfig): string {
...
function mergeSlackAccountConfig(cfg: AnimaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AnimaConfig): ResolvedSlackAccount[] {
