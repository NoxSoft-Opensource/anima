...
function listConfiguredAccountIds(cfg: AnimaConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AnimaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AnimaConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AnimaConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AnimaConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AnimaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AnimaConfig): ResolvedWhatsAppAccount[] {
