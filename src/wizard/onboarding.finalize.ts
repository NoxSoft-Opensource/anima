...
export async function finalizeOnboardingWizard(
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.anima.ai/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.anima.ai/security",
    "Security",
  );
  ...
  await prompter.note(
    'What now: https://anima.ai/showcase ("What People Are Building").',
    "What now",
  );
