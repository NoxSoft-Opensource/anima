    ...
    <div>
      ...
      {message && (
        <motion.div
          ...
          style={{
            fontSize: '13px',
            color: message.includes('error') || message.includes('Could not')
              ? 'var(--color-error)'
              : 'var(--color-success)',
            marginBottom: '16px',
          }}
      ...
      <div className="grid grid-2">
        {/* Wishes */}
        <div className="card">
          <div className="card-title" style={{ marginBottom: '16px' }}>Wishes</div>
          {wishes.length === 0 ? (
        ...
        {/* Exploration history */}
        <div className="card">
          <div className="card-title" style={{ marginBottom: '16px' }}>Exploration History</div>
          {explorations.length === 0 ? (
            <div style={{ color: 'var(--color-muted)', fontSize: '13px', padding: '20px 0', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {explorations.map((exploration, i) => (
                ...
                >
                  ...
                  <div style={{ fontSize: '11px', color: 'var(--color-muted)', display: 'flex', gap: '12px' }}>
