...
function SessionRow({ session, index }: { session: SessionEntry; index: number }) {
  ...
  return (
    ...
    >
      ...
      <td
        className="mono"
        style={{ color: session.costUsd != null ? "var(--color-text)" : "var(--color-muted)" }}
      >
  ...
  if (error) {
    return (
      <div>
        ...
        <div
          className="card"
          style={{ color: "var(--color-muted)", padding: "40px", textAlign: "center" }}
        >
    ...
    <div>
      ...
      <div style={{ marginTop: "16px", display: "flex", gap: "16px" }}>
        <div className="card" style={{ flex: 1, textAlign: "center" }}>
          ...
          <div
            style={{ fontSize: "11px", color: "var(--color-muted)", textTransform: "uppercase" }}
          >
            Total Sessions
          </div>
        </div>
        <div className="card" style={{ flex: 1, textAlign: "center" }}>
          ...
          >
            ${sessions.reduce((sum, s) => sum + (s.costUsd || 0), 0).toFixed(2)}
          </div>
          <div
            style={{ fontSize: "11px", color: "var(--color-muted)", textTransform: "uppercase" }}
          >
